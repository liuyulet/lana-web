     ...
     <!--   <el-button icon="el-icon-view" type="text" @click="showJson">
      ...
      <el-scrollbar class="center-scrollbar">
        <el-row  class="center-board-row" :gutter="formConf.gutter" >
          <el-col class="center-border-type" :span="this.topmaster" :offset="this.topoher">
   ...
   //预览
    ...
    checkStyle() {
      ...
      this.operationType = 'run'
        //默认页面模式（非弹框）
      let data={
        fileName: undefined, type: 'file'
      }
      //执行execShowPage方法
      const func = this[`exec${titleCase("showPage")}`]
